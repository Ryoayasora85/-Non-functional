...
#test=json.dumps(bbbbb, ensure_ascii=False, indent=4, sort_keys=True, separators=(',', ': '))
res_parsed=json.dumps(json_buckets_setting, default=json_serial, ensure_ascii=False, indent=4)
